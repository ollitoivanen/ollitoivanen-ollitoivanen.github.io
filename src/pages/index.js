...
const aboutMeText_1 =
  "Hello, I'm Olli, a long time software hobbyist and a second year software engineering student. I've been building my own apps and websites since 2017, all of which you can see on my ";
const aboutMeText_2 =
...
const IndexPage = () => {
  return (
    <main style={view_container}>
      ...
      <h2 style={text_name}>
        <a
          style={text_personal_links}
          href={"https://www.linkedin.com/in/ollitoivanen/"}
        >
          LinkedIn
        </a>
      </h2>
      <h2 style={text_name}>
        <a style={text_personal_links} href={"https://github.com/ollitoivanen"}>
          GitHub
        </a>
      </h2>
      ...
      <p style={text_about_me}>
        {aboutMeText_1}
        <a style={text_link} href="https://github.com/ollitoivanen">
          GitHub
        </a>
        {aboutMeText_2}
      </p>
